...
class _PlaneacionesListPageState extends State<PlaneacionesListPage>
  ...
  void _navigateToDraft(
      String modalidad, Map<String, dynamic> data, String draftId) {
  ...
  void _navigateToDetailPage(
    ...
    final campus =
        data['campus'] != null ? List<String>.from(data['campus']) : <String>[];
    final contenidos = data['contenidos'] != null
        ? List<Map<String, dynamic>>.from(data['contenidos'])
        : <Map<String, dynamic>>[];
    final seleccionGrados = data['seleccionGrados'] != null
        ? List<Map<String, dynamic>>.from(data['seleccionGrados'])
        : <Map<String, dynamic>>[];
  ...
  int _calculateProgress(Map<String, dynamic> data) {
    ...
    if (data['relevancia_social']?.toString().isNotEmpty == true)
      completedFields++;
    if (data['eje_articulador']?.toString().isNotEmpty == true)
      completedFields++;
              ...
              actions: [
                TextButton(
                  ...
                  child: const Text(
                    'Cancelar',
                    style:
                        TextStyle(color: Colors.grey, fontFamily: 'ComicNeue'),
                  ),
                ),
                ElevatedButton(
  ...
  void _editarPlaneacion(
    ...
    final List<String> campus =
        List<String>.from(planeacionData['campus'] ?? []);
    final List<Map<String, dynamic>> contenidos =
        List<Map<String, dynamic>>.from(planeacionData['contenidos'] ?? []);
