      ...
      build: (context) => pw.Column(
        ...
        children: [
          ...
          pw.Table.fromTextArray(
            ...
            data: [
              ['1. Punto de partida', momentos['punto_partida'] ?? ''],
              ['2. Planeación', momentos['planeacion'] ?? ''],
              ['3. ¡A trabajar!', momentos['a_trabajar'] ?? ''],
              ['4. Comunicamos nuestros logros', momentos['comunicamos_logros'] ?? ''],
              ['5. Reflexión sobre el aprendizaje', momentos['reflexion_aprendizaje'] ?? ''],
            ],
            headerStyle: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 10),
            cellStyle: pw.TextStyle(fontSize: 8),
            cellAlignment: pw.Alignment.topLeft,
