    ...
    pw.Page(
      ...
      build: (context) => pw.Column(
        ...
        children: [
          pw.Center(
            child: pw.Text(
              'Planeación Unidad Didáctica: $titulo',
          ...
          pw.Table.fromTextArray(
            ...
            data: [
              ['1. Lectura de la realidad', momentos['lectura_realidad'] ?? ''],
              ['2. Identificación de la trama y complejidad', momentos['identificacion_trama'] ?? ''],
              ['3. Planificación y organización del trabajo', momentos['planificacion'] ?? ''],
              ['4. Exploración y descubrimiento', momentos['exploracion'] ?? ''],
              ['5. Participación activa y horizontal', momentos['participacion'] ?? ''],
              ['6. Conclusión de la experiencia (Valoración)', momentos['conclusion'] ?? ''],
            ],
            headerStyle: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 10),
            cellStyle: pw.TextStyle(fontSize: 8),
            cellAlignment: pw.Alignment.topLeft,
