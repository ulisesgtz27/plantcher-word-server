...
pw.Document buildCentrosInteresPDF({
  ...
  pdf.addPage(
    pw.Page(
      ...
      build: (context) => pw.Column(
        ...
        children: [
          pw.Center(
            child: pw.Text('Planeación Centros de Interés: $titulo',
          ...
          pw.Table.fromTextArray(
            ...
            data: [
              ['1. En contacto de la realidad', momentos['contacto_realidad'] ?? ''],
              ['2. Identificación e integración', momentos['identificacion_integracion'] ?? ''],
              ['3. Expresión', momentos['expresion'] ?? ''],
            ],
            headerStyle: pw.TextStyle(fontWeight: pw.FontWeight.bold),
            cellAlignment: pw.Alignment.topLeft,
            columnWidths: {
