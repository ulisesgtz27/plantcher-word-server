...
class _DetallarProyectoPageState extends State<DetallarProyectoPage>
  ...
  void dispose() {
    ...
    planeacionController.dispose();
    trabajarController.dispose();
    comunicarLogrosController.dispose();
    reflexionController.dispose();
  ...
  void _loadExistingData() {
    try {
      print('📋 Cargando datos existentes en Proyecto...');
      ...
      setState(() {
        ...
        // Cargar momentos específicos de Proyecto
      ...
      isDraftLoaded = true;
      print('✅ Datos existentes cargados en Proyecto');
    } catch (e) {
      print('❌ Error cargando datos existentes en Proyecto: $e');
      isDraftLoaded = true;
    }
  }
  ...
  void _loadDraftData() {
    try {
      print('📋 Cargando datos del borrador en Proyecto...');
      ...
      isDraftLoaded = true;
      print('✅ Datos del borrador cargados en Proyecto');
      
    } catch (e) {
      print('❌ Error cargando datos del borrador en Proyecto: $e');
      isDraftLoaded = true;
    }
  }
  ...
  Future<void> _saveDraft() async {
    ...
    try {
      ...
      print('Error guardando borrador Proyecto: $e');
    }
  }
  ...
  // ✅ FUNCIÓN MODIFICADA: Mejorar guardarDetalleProyecto
  Future<void> guardarDetalleProyecto() async {
    ...
    try {
      ...
      print('❌ Error guardando detalle de proyecto: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Error al guardar: $e',
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  border: OutlineInputBorder(
                                    ...
                                    borderSide: BorderSide(color: const Color(0xFF001F54).withOpacity(0.3)),
                                  ),
  ...
  Widget _seccionContenedor(List<Widget> children) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: const Color(0xFF001F54).withOpacity(0.2),
          width: 1,
        ),
      ),
      child: Column(
  ...
  Widget _fechaSelector(String hint, DateTime? fecha, Function(DateTime) onSelected, String prefix) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(color: const Color(0xFF001F54).withOpacity(0.3)),
          borderRadius: BorderRadius.circular(12),
        ),
        child: Text(
          fecha == null
