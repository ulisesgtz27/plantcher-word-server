...
class _DetallarRinconesPageState extends State<DetallarRinconesPage>
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _seccionContenedor([
                        ...
                        _input(relevanciaController,
                            'Describe la relevancia social...'),
                      ]),
                      _seccionContenedor([
                      ...
                      _seccionContenedor([
                        _titulo('Materiales'),
                        _listaEditable(
                            materiales, materialInput, 'Agregar material'),
                      ]),
                      _seccionContenedor([
                        _titulo('Espacios'),
                        _listaEditable(
                            espacios, espacioInput, 'Agregar espacio'),
                      ]),
                      _seccionContenedor([
                        _titulo('Producción sugerida'),
                        _listaEditable(
                            produccion, produccionInput, 'Agregar producción'),
                      ]),
  ...
  Widget _fechaSelector(String hint, DateTime? fecha,
      Function(DateTime) onSelected, String prefix) {
    return InkWell(
      onTap: () async {
