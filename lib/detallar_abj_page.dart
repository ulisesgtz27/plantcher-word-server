...
class _DetallarABJPageState extends State<DetallarABJPage>
  ...
  void _loadExistingData() {
    try {
      print('📋 Cargando datos existentes en ABJ...');
      ...
      setState(() {
        ...
        // Cargar momentos específicos de ABJ
      ...
      isDraftLoaded = true;
      print('✅ Datos existentes cargados en ABJ');
    } catch (e) {
      print('❌ Error cargando datos existentes en ABJ: $e');
      isDraftLoaded = true;
    }
  }
  ...
  void _loadDraftData() {
    try {
      print('📋 Cargando datos del borrador en ABJ...');
      ...
      isDraftLoaded = true;
      print('✅ Datos del borrador cargados en ABJ');
      
    } catch (e) {
      print('❌ Error cargando datos del borrador en ABJ: $e');
      isDraftLoaded = true;
    }
  }
  ...
  Future<void> _saveDraft() async {
    ...
    try {
      ...
      print('Error guardando borrador ABJ: $e');
    }
  }
  ...
  // ✅ FUNCIÓN MODIFICADA: Mejorar guardarDetalleABJ
  Future<void> guardarDetalleABJ() async {
    ...
    try {
      ...
      print('❌ Error guardando detalle de ABJ: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Error al guardar: $e',
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  border: OutlineInputBorder(
                                    ...
                                    borderSide: BorderSide(color: const Color(0xFFFF5722).withOpacity(0.3)),
                                  ),
