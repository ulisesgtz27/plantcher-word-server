...
def log_request_info():
    print(f"🚀 SOLICITUD ENTRANTE: {request.method} {request.path}")
    print(f"🌐 IP Cliente: {request.remote_addr}")
    if request.is_json:
        print(f"📦 Tiene datos JSON: Sí")
    else:
        print(f"📦 Tiene datos JSON: No")
...
def generar_word():
    ...
    try:
        ...
        print(f"📄 Generando archivo para modalidad: {modalidad}")
...
def test_post():
    ...
    print("🧪 TEST-POST: Endpoint de prueba POST accedido")
    data = request.json
...
def get_modalidades():
    ...
    print("📋 MODALIDADES: Solicitando lista de modalidades")
    return jsonify({
...
if __name__ == '__main__':
    ...
    print("🚀 INICIANDO SERVIDOR PLANTCHER WORD")
